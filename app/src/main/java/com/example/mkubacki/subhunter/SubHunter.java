package com.example.mkubacki.subhunter;
...
public class SubHunter extends Activity {
    ...
    void draw() {
        ...
        canvas.drawRect(horizontalTouched * blockSize, verticalTouched * blockSize, (horizontalTouched * blockSize)
        + blockSize, (verticalTouched * blockSize) + blockSize, paint);
...
id
            //Process the players shot by passing the coordinates of the players finger to takeshot
    ...
    void takeShot(float touchX, float touchY){
        ...
        int horizontaGap = (int) horizontalTouched - subHorizontalPosition;
        int verticalGap = (int) verticalTouched - subVerticalPosition;

        //Use Pythagoras thereom to get the distance travelled in a straight line
        distanceFromSub = (int) Math.sqrt((horizontaGap*horizontaGap) + (verticalGap*verticalGap));
        if (hit)
            boom();
        else draw();
    }
